...
typedef enum {
  ...
  CMARK_NODE_MATH          = CMARK_NODE_TYPE_INLINE | 0x0005,
  CMARK_NODE_HTML_INLINE   = CMARK_NODE_TYPE_INLINE | 0x0006,
  CMARK_NODE_CUSTOM_INLINE = CMARK_NODE_TYPE_INLINE | 0x0007,
  CMARK_NODE_EMPH          = CMARK_NODE_TYPE_INLINE | 0x0008,
  CMARK_NODE_STRONG        = CMARK_NODE_TYPE_INLINE | 0x0009,
  CMARK_NODE_LINK          = CMARK_NODE_TYPE_INLINE | 0x000a,
  CMARK_NODE_IMAGE         = CMARK_NODE_TYPE_INLINE | 0x000b,
  CMARK_NODE_FOOTNOTE_REFERENCE = CMARK_NODE_TYPE_INLINE | 0x000c,
} cmark_node_type;
...
#define NODE_MATH CMARK_NODE_MATH
